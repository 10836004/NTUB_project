...
//註冊帳號
public class bgw1   extends AsyncTask<String,Void,String> {
    Context context;
    ...
    protected String doInBackground(String... paramss) {
        String type = paramss[0];
        String login_url =" http://192.168.43.188/SQLite_insert1.php";
        if (type.equals("si1")){
            try {
                String mmm1 = paramss[1];
                String mmm2 = paramss[2];
                //String mmm3 = paramss[3];
                //String mmm4 = paramss[4];
                ...
                String post_data = URLEncoder.encode("mmm1" ,"UTF-8")+"="+URLEncoder.encode(mmm1 ,"UTF-8")+"&"+
                        ...
                        //.encode("mmm3" ,"UTF-8")+"="+URLEncoder.encode(mmm3 ,"UTF-8")+"&"+

...
public class LoginMain_SQL {
    public static String executeQuery1(String account,String h,String kg,String BMI,String body,String body1,String body2,String body3,String body4,String body5,String body6,String body7,String body8,String body9) {
        String result = "";
        try {
            HttpClient httpClient = new DefaultHttpClient();
            HttpPost httpPost = new HttpPost("http://172.17.135.98/SQL_changemyselfnews.php");

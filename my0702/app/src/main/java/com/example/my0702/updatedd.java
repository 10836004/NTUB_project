...
public class updatedd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_updatedd);
        ...
        try {
            String result = MainActivityloginSQL.executeQuery1("SELECT * FROM `calender` where `id` = '"+TextView1.getText().toString()+"' ");
            ...
            for(int i=0;i<jsonArray.length();i++  ) {
                ...
                itemMain.setBackgroundColor(Color.parseColor("#00BBFF")); //設定背景色
                ...
                itemMain.findViewById(Integer.parseInt(jsonData.getString("idid"))).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        Intent intent1 = new Intent(updatedd.this, updatediary.class);
    ...
    private View.OnClickListener buttonhome = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent intent = new Intent(updatedd.this, profile_choice.class);

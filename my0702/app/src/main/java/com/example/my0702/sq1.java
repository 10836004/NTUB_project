...
public class sq1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sq1);

        mmm1 = findViewById(R.id.id123);
        mmm2 = findViewById(R.id.name123);
        //mmm3 = findViewById(R.id.pw1234);
       // mmm4 = findViewById(R.id.sex123);
        Button btn0 = findViewById(R.id.btn6666);
        Button btn1 = findViewById(R.id.button4321);
        btn0.setOnClickListener(btnAdd1OnClick10);
    ...
    private View.OnClickListener btnAdd1OnClick1 = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (mmm1.getText().toString().matches("") || mmm2.getText().toString().matches("")) {


                Toast toast = Toast.makeText(sq1.this, "欄位不能是空白!!", Toast.LENGTH_LONG);
                toast.show();

            } else {
                Intent intent = new Intent(sq1.this, SQLite.class);
    ...
    private View.OnClickListener btnAdd1OnClick10 = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            //SQLiteDatabase friendDb = mFriendDbopenHelp.getWritableDatabase();
            ...
            Intent intent = new Intent(sq1.this, MainActivity2__login.class);
            //intent.putExtra("mmm1",  mmm1.getText().toString());        //傳入點選事件之項目
            //intent.putExtra("mmm2",  mmm2.getText().toString());
            //intent.putExtra("mmm3", mmm3.getText().toString());
            //intent.putExtra("mmm4",  mmm4.getText().toString());
